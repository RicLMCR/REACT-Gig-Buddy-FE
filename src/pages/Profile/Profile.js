...
const Profile = ({ user, apiData, trendingEvents, imageUrl , setImageUrl }) => {
          ...
          <div className="profile-bio">
            ...
            <div className="bio-container">
              <p className="bio-text">
                ...
                Adipisci est dolor temporibus quos minima, sed consequatur!
                Accusantium facere, labore ipsam, quas voluptates sit provident
                minima expedita sapiente hic consequuntur voluptatem.
              </p>
            </div>
          </div>
